<div class="invitations index">
	...
	<tr>
		...
		<td><?php echo h($invitation['Invitation']['sender_id']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $invitation['Invitation']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $invitation['Invitation']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
