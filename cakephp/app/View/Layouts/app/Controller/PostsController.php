 ...
 */
	public function index() {
		...
		//$this->set('Salary', $this->Salaries->find('all'));
		//$this->set('TimePart', $this->TimeParts->find('all'));
		//$this->set('Country', $this->Countries ->find('all'));
		//$this->set('User', $this->Users->find('all'));
		//$this->set('Category', $this->Categories->find('all'));
