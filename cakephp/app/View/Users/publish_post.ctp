...
<div class="landing-page"><div class="form-appointment">
...
?> -->
											...
											<?php echo $this->Form->input('salaries_id', array('label' => 'Chon mức lương', 'options' => array('1'=>'< 500.000','2'=>'500.000 - 1.000.000', '3'=>'1.000.000 - 2.000.000','4'=>'2.000.000 - 3.000.000',
											'5'=>'3.000.000 - 4.000.000','6'=>'5.000.000', '7' => '> 5.000.000'), 'class' => 'form-control')); ?>
										
									</span>
									<span class="wpcf7-list-item">
										
											<?php echo $this->Form->input('time_parts_id', array('label' => 'Loại thời gian', 'options' => array('1'=>'Toàn thời gian',
											'2'=>'Bán thời gian'), 'class' => 'form-control')); ?>
										
									</span>
									<br>
									<span class="wpcf7-list-item">
										
											<?php echo $this->Form->input('countries_id', array('label' => 'Thành phố', 'options' => array('1' => 'Đà Nẵng'), 
											'class' => 'form-control')); ?>
									...
									<span class="wpcf7-list-item">
											...
											<?php echo $this->Form->input('categories_id', array('label' => 'Tên danh mục', 'options' => array('1' => 'Chăm sóc trẻ',
											'2' => 'Chăm sóc người già','3' => 'Làm việc toàn thời gian','4' => 'Làm việc bán thời gian','5' => 'Giúp việc văn phòng'), 
											'class' => 'form-control')); ?>
									...
									<span class="wpcf7-list-item">
											...
											<?php echo $this->Form->input('end_date',array('label' => 'Ngày hết hạn bài đăng','type' => 'text','id' => 'datepicker', 
											'class'=>'form-control')); ?>
