     ...
     <?php 
			...
			<div id="blogCarousel" class="carousel slide ">
				...
				<h3>THÔNG TIN CHUNG VỀ BÀI ĐĂNG</h3>
					<tbody>
						<tr>
							<td>Đăng vào ngày</td>
							<td><?php echo h($user['Post']['created']); ?>
							&nbsp;</td>
						</tr>
						<tr>
							<td>Danh mục</td>
							<td><?php echo 
							$this->Html->link($user['Categories']['name'], array('controller' => 'categories', 'action' => 'view', $user['Categories']['id'])); ?>
							&nbsp;</td>
						</tr>
						<tr>
							<td>Lương</td>
							<td><?php echo $this->Html->link($user['Salaries']['salaries'], array('controller' => 'salaries', 'action' => 'view', $user['Salaries']['id'])); ?>
							&nbsp;</td>

						</tr>
						<tr>
							<td>Nơi làm việc</td>
							<td><?php echo $this->Html->link($user['Countries']['city'], array('controller' => 'countries', 'action' => 'view', $user['Countries']['id'])); ?>
							&nbsp;</td>
						</tr>
					</tbody>
				</table>
        ...
        <div class="span6">
            ...
            <!-- Carousel items -->
				...
				<h4><?php echo h($user['Post']['title']); ?></h4>
					<?php echo ($user['Post']['content']); ?>
